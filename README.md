# "Introdução à Programação Aplicada à Cibersegurança" Class Exercises Repository
...
<h2>About the Course</h2> 
    This class focused on various topics such as the structure of an algorithm vs the structure of a Python program, logical and arithmetic operations, decision structures, repetition structures, data structures, functions, strings, among others.
